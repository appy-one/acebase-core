...
//     interface ILiveDataProxyValue<T> {
//         /**
...
//         /**
//          * Gets the value wrapped by this proxy. This value is still live, meaning that it is still being 
//          * updated with changes made in the database, BUT any changes made to this object will NOT be saved 
//          * to the database!
//          */
//         getTarget(): T
//         /**
...
//          * monitored, make sure you are not creating an endless loop!
...
//      */
//     interface DataProxyOnChangeCallback<T> { 
//         /**
