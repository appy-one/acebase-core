...
export interface AceBaseBaseSettings {
    /**
     * What level to use for console logging.
     * @default 'log'
     */
    logLevel?: 'verbose'|'log'|'warn'|'error'
    /** Whether to use database name prefixes in the console logs output. Not implemented yet */
    logPrefixing?: boolean
    /** Whether to use colors in the console logs output. Not implemented yet */
    logColors?: boolean
}
